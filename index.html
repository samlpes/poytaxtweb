                    ...
                    <nav class="navbar navbar-expand-md navbar-light ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                                ...
                                <a class="nav-item nav-link" href="./english.html">EN</a>
                            </div>
                        </div>
                    </nav>
                </div>
                ...
                <div class="news__inner">
                    <div class="workers">
                        ...
                        <div class="news__blog-text">
                            ...
                            - более 50 успешных проектов по развитию предприятия<br>
                            - большой опыт работы в индустрии<br>
                            - контроль финансовых операций предприятия<br>
                            - 
                        </div>
                    </div>
                    <div class="workers">
                        ...
                        <div class="news__blog-text">
                            ...
                            - член совета директоров<br>
                            - более 9 лет опыта в продажах<br>
                            - разработка стратегии и плана развития предприятия<br>
                            - управление и мотивация сотрудников отдела закупки и отдела продаж<br>
                            - контроль эффективности использования ресурсов<br>
                        </div>
                    </div>
                    <div class="workers">
                        <div class="news__images">
                            <img src="IMG/staff/исмоилов.png" alt="" style="width: 243px;  border-start-end-radius: 8px; border-start-start-radius: 8px; border-end-start-radius: 4px; border-end-end-radius: 4px;">
                        </div>
                        <div class="news__blog-title">
                            Исмоилов Джасур
                        </div>
                        <div class="news__blog-text">
                            Ответственный по складу и производству<br>
                            - __ лет опыта работы<br>
                            - руководство персонала<br>
                            - ответственный за производство<br>
                            - ответсвенный за обучение и найм нового персонала<br>
                        </div>
                    </div>
                    <!-- <div class="workers">
                        <div class="news__images">
